						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h3>
										<i class="fa fa-youtube-play"></i> Published Videos
								...
								<div style="margin: 50px;">
									...
									?>
											<div class="page-header page-heading">
												<h1 class="row">
													<div class="col-md-6"><i class="fa fa-search"></i> Search Youtube</div>
													<div class="col-md-6">
													...
													<div class="big-search-form">
														<form method="GET" action="videos.php">
															...
															<div class="form-group">
																...
																<input type="text" name="q" class="form-control" placeholder="Search in youtube.com" value="<?php if (isset($q)) {
																																								echo urldecode($q);
																																							} ?>" />
															</div>
															<div class="form-group">
																...
																<select name="order_by" class="form-control">
																	<option value="date" <?php if (isset($order_by) and $order_by == 'date') {
																								echo 'SELECTED';
																							} ?>>By Date</option>
																	<option value="rating" <?php if (isset($order_by) and $order_by == 'rating') {
																								echo 'SELECTED';
																							} ?>>By Rating</option>
																	<option value="relevance" <?php if (isset($order_by) and $order_by == 'relevance') {
																									echo 'SELECTED';
																								} ?>>By Relevance</option>
																	<option value="title" <?php if (isset($order_by) and $order_by == 'title') {
																								echo 'SELECTED';
																							} ?>>By Title</option>
																	<option value="viewCount" <?php if (isset($order_by) and $order_by == 'viewCount') {
																									echo 'SELECTED';
																								} ?>>By View Count</option>
																</select>
															</div>
															<div class="form-group">
																...
																<select name="max_results" class="form-control">
																	<?php for ($i = 12; $i < 49; $i = $i + 6) { ?>
																		<option value="<?php echo $i; ?>" <?php if (isset($max_results) and $max_results == $i) {
																												echo 'SELECTED';
																											} ?>><?php echo $i; ?></option>
																	<?php } ?>
																</select>
										...
										?>
											<div class="page-header page-heading">
												<h1 class="row">
													<div class="col-md-6"><i class="fa fa-search"></i> Search DailyMotion</div>
													<div class="col-md-6">
												...
												<div class="col-md-3">
													<div class="big-search-form">
														<form method="GET" action="videos.php">
															...
															<div class="form-group">
																<label>Search Word</label>
																<input type="text" name="q" class="form-control" placeholder="Search in dailymotion.com" value="<?php if (isset($q)) {
																																									echo str_replace('+', ' ', $q);
																																								} ?>" />
															</div>
															<div class="form-group">
																<label>Order By</label>
																<select name="order_by" class="form-control">
																	<option value="recent" <?php if (isset($order_by) and $order_by == 'recent') {
																								echo 'SELECTED';
																							} ?>>By Date</option>
																	<option value="rated" <?php if (isset($order_by) and $order_by == 'rated') {
																								echo 'SELECTED';
																							} ?>>By Rating</option>
																	<option value="relevance" <?php if (isset($order_by) and $order_by == 'relevance') {
																									echo 'SELECTED';
																								} ?>>By Relevance</option>
																	<option value="trending" <?php if (isset($order_by) and $order_by == 'trending') {
																									echo 'SELECTED';
																								} ?>>By Trending</option>
																	<option value="visited" <?php if (isset($order_by) and $order_by == 'viewCount') {
																								echo 'SELECTED';
																							} ?>>By View Count</option>
																</select>
															</div>
												...
												<div class="row">
													...
													<div class="col-md-3">
														...
														<div class="form-group">
															...
															<input type="text" class="form-control tags" name="tags" id="tags" value="<?php if (isset($news['tags'])) {
																																			echo $news['tags'];
																																		} ?>" />
														</div>
														<div class="form-group">
															<input type="checkbox" name="published" id="published" value="1" <?php if ($news['published'] == 1) {
																																	echo 'CHECKED';
																																} ?> /> <span class="checkbox-label">Publish news ?</span>
														</div>
										...
										?>
											<div class="page-header page-heading">
												<h1 class="row">
													<div class="col-md-6"><i class="fa fa-search"></i> Search For <?php echo $q; ?> In Published Videos</div>
													<div class="col-md-6">
										...
										case 'channel';
											...
											?>
											<div class="page-header page-heading">
												<h1><i class="fa fa-th-large"></i> <?php if ($id == 0) {
																						echo 'Single Videos';
																					} else {
																						echo 'Imported Videos From ' . $source['title'];
																					} ?></h1>
											</div>
											<?php
											if (isset($message)) {
