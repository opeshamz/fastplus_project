                        ...
                        id="signupform" onsubmit="return signupValidation()">
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                   ...
                                   <div ><?php include("error.php"); ?></div>
                                    <div><?php include("sucess.php"); ?></div>
                                <hr/>
                                <div class="mb-1">
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-md-12">
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" id="terms_and_conditions"value="yes" checked onload="terms_changed(this)">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                <input type="checkbox" value="true" name="news">
                                                <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
